...
public class OdysseyActivity extends AppCompatActivity {
    ...
    public void selectFragment(View view)
    {
        ...
        {
            fr = new FragmentOdysseyDescription();
        }
        //Otherwise 'Specs' button
        else
        {
            fr = new FragmentOdysseySpecs();
        }
    ...
    {
        Intent intent = new Intent(this, OdysseyGalleryActivity.class);
